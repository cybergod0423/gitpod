...
export class GitpodServerEEImpl extends GitpodServerImpl<GitpodClient, GitpodServer> {
    ...
    initialize(client: GitpodClient | undefined, clientRegion: string | undefined, user: User, accessGuard: ResourceAccessGuard, token: GitpodToken | undefined): void {
        super.initialize(client, clientRegion, user, accessGuard, token);
